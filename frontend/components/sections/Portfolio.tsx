...
const localProjects: Project[] = [
  ...
  },
  {
    ...
    {
    id: 'local-video-15',
    title: 'فيديو عمل ميداني 7',
    description:
      'عرض جديد لأعمال شركة رياح الجليد أثناء تنفيذ وتركيب أنظمة التكييف داخل المشروع بجودة وتنظيم عالي.',
    video: '/portfolio/15.mp4',
    category: 'فيديو أعمال',
    createdAt: '2026-04-01T10:12:00.000Z',
  },
  {
    id: 'local-video-16',
    title: 'فيديو عمل ميداني 8',
    description:
      'لقطات إضافية من تنفيذات رياح الجليد للمكيفات والدكت مع إبراز دقة العمل والتشطيب النهائي.',
    video: '/portfolio/16.mp4',
    category: 'فيديو أعمال',
